...
impl BundleBoxProvider {
    ...
    // pub fn add_package_with_conditional_deps(
    //     &mut self,
    //     name: impl Into<String>,
    //     pack: Pack,
    //     deps: &[&str],
    //     conditional_deps: &[(impl AsRef<str>, &[&str])],
    //     constrains: &[&str],
    // ) {
    //     let name = name.into();
    //     let mut dependencies = BundleBoxPackageDependencies {
    ...
    //     for dep in deps {
    //         let specs = Spec::parse_union(dep)
    //             .map(|r| r.expect("invalid dependency spec"))
    //             .collect();
    //         dependencies.dependencies.push(specs);
    //     }

    //     // Add conditional dependencies
    //     for (condition, deps) in conditional_deps {
    //         let condition_spec = Spec::parse_union(condition.as_ref())
    //             .next()
    ...
    //         let spec = Spec::parse_union(constrain)
    //             .next()
    //             .expect("invalid constrain spec")
    //             .expect("invalid constrain spec");
    //         dependencies.constrains.push(spec);
    //     }
